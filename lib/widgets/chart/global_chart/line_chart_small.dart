...
class LineChartSmall extends StatefulWidget {
  ...
  @override
  State<LineChartSmall> createState() => _LineChartSmallState();
}

class _LineChartSmallState extends State<LineChartSmall> {
