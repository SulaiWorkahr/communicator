...
class DonutChartContent extends StatefulWidget {
  List<dynamic> chartData = [];
  var chartTitle = '';
  var chartValue = '';

  DonutChartContent(this.chartData, this.chartTitle, this.chartValue,
      {Key? key})
      : super(key: key);

  @override
  State<DonutChartContent> createState() => _DonutChartContentState();
}

class _DonutChartContentState extends State<DonutChartContent> {
  int touchedIndex = -1;
